...
namespace DBManager
{
    ...
    {  
        ...
        //вар2
        public static Dictionary<string, string> GetSQLTypeConversionMap()
        {
       ...
       /* public static DbTable LoadToDb(string connStr)
        {
            ...
            DbTable tbl;// new DbTable(tblName);
            return new DbTable (tblName);
        }*/

        public static void UploadCsvToDbTable(string connStr, string fileName, string tableName)
        {
            ...
            //------------------------add of table--------------------------------------
          //  DbTable tbl=null;
          //  DbTable curTbl = new DbTable(tableName);
          //  tbl.dbInfo.AddTable(curTbl);
        }

        /*private static DbTable CreateSQLTable(string connStr, string tableName, List<DbTblFldDesc> listOfFieldDescriptions)
        {
            DbTable tbl = new DbTable(tableName);
